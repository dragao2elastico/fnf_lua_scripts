...
function onCreate()
	if makeLuaSprite('winningIcon', 'icons/win-'..getProperty('boyfriend.healthicon'), getProperty('iconP1.x'), getProperty('iconP1.y')) then
	...
	if makeLuaSprite('winningIconDad', 'icons/win-'..getProperty('boyfriend.healthicon'), getProperty('iconP2.x'), getProperty('iconP2.y')) then
